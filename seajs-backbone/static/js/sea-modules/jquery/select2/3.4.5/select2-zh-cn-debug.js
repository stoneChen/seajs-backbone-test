define("jquery/select2/3.4.5/select2-zh-cn-debug", [ "$-debug", "./select2-debug" ], function(require, exports, module) {
    var jQuery = require("$-debug");
    var select2 = require("./select2-debug");
    /**
...
define("jquery/select2/3.4.5/select2-debug", [ "$-debug" ], function(require, exports, module) {
    var jQuery = require("$-debug");
    /*
