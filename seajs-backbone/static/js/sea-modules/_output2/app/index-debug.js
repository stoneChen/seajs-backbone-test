define("/seajs-backbone/static/js/sea-modules/_output2/app/index-debug", [ "jquery/jquery/1.7.2/jquery-debug", "gallery/underscore/1.5.2/underscore-debug", "gallery/backbone/1.1.0/backbone-debug", "$-debug", "../model/M_index-debug", "../view/V_index-debug", "../tpl/index-debug.tpl", "jquery/select2/3.4.5/select2-zh-cn-debug" ], function(require, exports, module) {
    "use strict";
...
define("/seajs-backbone/static/js/sea-modules/_output2/view/V_index-debug", [ "jquery/jquery/1.7.2/jquery-debug", "gallery/underscore/1.5.2/underscore-debug", "gallery/backbone/1.1.0/backbone-debug", "$-debug", "jquery/select2/3.4.5/select2-zh-cn-debug" ], function(require, exports, module) {
    "use strict";
    var $ = require("jquery/jquery/1.7.2/jquery-debug"), _ = require("gallery/underscore/1.5.2/underscore-debug"), Backbone = require("gallery/backbone/1.1.0/backbone-debug"), tpl = require("/seajs-backbone/static/js/sea-modules/_output2/tpl/index-debug.tpl");
